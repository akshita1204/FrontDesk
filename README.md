...
The objective was to build a **Front Desk Management System** using **NestJS** (a progressive Node.js framework) to handle scalable backend functionality efficiently.  
